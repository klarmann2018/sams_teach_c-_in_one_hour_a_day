 ...
 *       Filename:  ex_02.cpp
 *
 *    Description:  Write a nested Loop equivalent of Listing 6.13 that adds
 *    Elements in two Arrays, but in Reverse Oder.
 *
 *        Version:  1.0
 *        Created:  2018年10月08日 17时59分18秒
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  bo lee
...
int main()
{
    ...
    cout << "Add each int in MyInts1 by each in MyInts2:" << endl;
